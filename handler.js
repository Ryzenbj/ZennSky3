                    ...
                    for (let user of participants) {
                       let pp = './src/avatar_contact.png
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Travelers just arrived!').replace('@subject', groupMetadata.subject).replace('@desc', groupMetadata.desc.toString()) :
                                )chat.sBye || this.bye || conn.bye || 'Travelers just leaving'))
